...
from utils.storage import upload_file, get_presigned_url, delete_file
...
def get_progress_photos():
    ...
    try:
        ...
        for photo in photos:
            result.append({
                'id': photo.id,
                'url': get_presigned_url(photo.photo_url),
...
def upload_progress_photo():
    ...
    try:
        ...
        if 'photo' in request.files:
            ...
            photo_key = upload_file(file, 'progress_photos', file_ext)
            ...
            import io
            file_obj = io.BytesIO(base64.b64decode(encoded))
            photo_key = upload_file(file_obj, 'progress_photos', ext)
        ...
        return jsonify({
            ...
            'photo': {
                ...
                'url': get_presigned_url(progress_photo.photo_url),
